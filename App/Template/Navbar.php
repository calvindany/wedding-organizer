...
?>
<nav class="navbar navbar-expand-lg shadow-sm p-4" style="background-color: #091540;">
    <div class="container d-flex justify-content-between">
        <a class="navbar-brand text-white" href="<?php echo $BASE_URL ?>">E-Mading</a>
        ...
        <?php
            if (false) {
                ...
                echo '<a class="nav-link active text-white" aria-current="page" href="'. $BASE_URL . '/admin">Katalog</a>';
                echo '</li>';
                echo '<li class="nav-item">';
